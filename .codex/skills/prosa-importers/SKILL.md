...
description: Importer normalization workflow for Codex, Claude Code, Gemini CLI, and Cursor sources in prosa. Use when modifying src/importers, source discovery, format-specific types, fixture parsing, tool call/result matching, subagent relationships, timeline confidence, or importer tests.
---
