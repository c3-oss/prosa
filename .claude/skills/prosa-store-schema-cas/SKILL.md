...
description: Bundle, SQLite schema, raw preservation, content-addressed storage, and idempotency guidance for prosa. Use when changing core bundle, schema, CAS, ingest helpers, IDs, raw records, objects, source files, or normalized tables.
---
...
3. Derived indexes: `search_docs` and FTS5 triggers.
