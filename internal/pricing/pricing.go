...
// gpt56SolPeriods is shared by gpt-5.6-sol and gpt-daybreak-blue (OpenAI's
// Daybreak program alias for Sol) so the two can never drift apart.
var gpt56SolPeriods = []ratePeriod{
