import { type CheckStatus, defaultBundlePath, runDoctor } from '@c3-oss/prosa-core'
...
export function doctorCommand(): Command {
  return new Command('doctor')
    ...
    .option('--checks <list>', 'comma-separated check names or dotted prefixes to include (default: all)')
