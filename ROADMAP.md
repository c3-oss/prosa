...
A browser product surface and authenticated console live as an eight-lane spec under [`docs/roadmap/web-platform/`](./docs/roadmap/web-platform/). The product covers a public marketing site, browser auth and tenant flows backed by the existing `apps/api`, and a tenant-scoped console for sessions, search, timeline detail, tool calls, analytics, and team settings. Each lane is independently scoped:

- [`01-product-surface.md`](./docs/roadmap/web-platform/01-product-surface.md) — product surface, route map, visual system, component vocabulary.
- [`02-frontend-foundation.md`](./docs/roadmap/web-platform/02-frontend-foundation.md) — `apps/web` workspace with Vite + React + TanStack Router + tRPC client.
- [`03-browser-auth-tenancy.md`](./docs/roadmap/web-platform/03-browser-auth-tenancy.md) — browser signup, login, tenant creation, switching, and team settings.
- [`04-read-api-v0.md`](./docs/roadmap/web-platform/04-read-api-v0.md) — tRPC read procedures: `sessions.list/detail`, `search.query`, `toolCalls.list`, `artifacts.getText`, `analytics.report`.
- [`05-console-shell-sessions.md`](./docs/roadmap/web-platform/05-console-shell-sessions.md) — console shell, navigation, sessions table and filters.
- [`06-session-detail-timeline.md`](./docs/roadmap/web-platform/06-session-detail-timeline.md) — structured session timeline and inspector.
- [`07-search-analytics-artifacts.md`](./docs/roadmap/web-platform/07-search-analytics-artifacts.md) — global search UI, analytics report views, artifact previews.
- [`08-production-readiness.md`](./docs/roadmap/web-platform/08-production-readiness.md) — performance, accessibility, Playwright E2E, deployment.
