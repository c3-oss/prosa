...
- [ ] No open blocking corrections. *(`CQ-104` is open for Lane 3:
  `derivedLayerEpochsTouched()` must count artifact-bearing epochs, not empty
  SessionBlob epoch directories.)*
