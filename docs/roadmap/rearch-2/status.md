...
Current HEAD: `633ee9b` (`listSupersededSegmentsFromManifests` + `summariseSupersededSegments` + `prosa index-v2 superseded-segments` audit/GC primitive).
No-change streak: 0
Ralph active: yes
