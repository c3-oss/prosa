...
Current HEAD: pending (`listCompactionHistory` per-manifest timeline + `prosa index-v2 compaction-history` CLI subcommand).
No-change streak: 0
Ralph active: yes
...
(none — `CQ-091`..`CQ-111` are all closed.)
