...
| 03 - Derived layer | Ralph | scaffold + SessionBlobPackV2 byte layout + Parquet compaction planner landed; Tantivy + DuckDB views + runtime Parquet merge pending | `bb76006`, `ba87f05` + (this iteration) | `evidence/lane-03.md` |
