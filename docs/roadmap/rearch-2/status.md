...
- Lane 7 CLI and MCP: **not started; next active milestone**.
- Lane 8 Audit and GC: **not started; follows Lane 7 in the next loop**.
- Lane 9 Migration: **not started; follows Lane 8 in the next loop**.
