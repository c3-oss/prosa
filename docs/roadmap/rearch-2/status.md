...
Current HEAD: pending pin (`loadTranscriptFromBundle({ epoch })` + `prosa index-v2 transcript --epoch <n>` historical-pack selector).
No-change streak: 0
Ralph active: yes
