...
Current HEAD: pending pin (`buildCompactManifestV2` + `prosa index-v2 compaction-manifest` Lane 3 `compact.manifest.cbor` deliverable).
No-change streak: 0
Ralph active: yes
