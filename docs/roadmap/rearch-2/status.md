...
Current HEAD: `d5ea090` (`verifyAllSessionBlobPacks` + `prosa index-v2 verify-packs` bundle-wide integrity audit).
No-change streak: 0
Ralph active: yes
