...
Current HEAD: `4a754ad` (`formatTranscriptTextV2` v2 text renderer + `prosa index-v2 transcript --format text|json` flag + CQ-105 pre-read format validation).
No-change streak: 0
Ralph active: yes
