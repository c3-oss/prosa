...
Current HEAD: pending pin (`prosa index-v2 projection-segments` Parquet segments listing + summary subcommand).
No-change streak: 0
Ralph active: yes
