...
Current HEAD: pending (`detectCompactionOverlaps` cross-seq correctness audit + `prosa index-v2 compaction-overlaps` CLI subcommand).
No-change streak: 0
Ralph active: yes
