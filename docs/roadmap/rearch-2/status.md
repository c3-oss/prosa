...
Current HEAD: `fa49eb2` (`planTantivyRebuildFromBundle` orchestration); roadmap reconciliation for that commit lands in this iteration.
No-change streak: 0
Ralph active: yes
