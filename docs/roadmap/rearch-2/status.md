...
Current HEAD: pending Tantivy index-dir probe commit (after `3f54ca6`).
No-change streak: 0
Ralph active: yes
...
(none — `CQ-091`, `CQ-092`, and `CQ-093` are all closed in this and
prior iterations; Lane 2 acceptance still pending Codex/governor/user
sign-off.)
