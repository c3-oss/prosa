...
Current HEAD: pending pin (`apps/cli/test/cli/index-v2-compaction-lifecycle.test.ts` end-to-end compaction-lifecycle audit test).
No-change streak: 0
Ralph active: yes
