...
Current HEAD: pending CQ-098 fix commit (after `eb88037`).
No-change streak: 0
Ralph active: yes
...
| 03 - Derived layer | Ralph | scaffold + SessionBlobPackV2 byte layout + Parquet compaction planner + DuckDB analytics view shape contract + Tantivy schema/rebuild-planner + SessionBlob projection-bridge with UTF-8 byte accounting + cross-page transcript iterator + Tantivy IndexCheckpointV2 persistence with atomic replacement + analytics execution-plan composer + Tantivy index-dir probe with CQ-094 final-component + CQ-096 intermediate symlink rejection + `planTantivyRebuildFromBundle` orchestration + compaction execution-plan composer + `derivedPaths` centralised layout + `clearTantivyIndexDir` reset helper + SessionBlob pack-path resolver + `loadSessionBlobPack` loader with CQ-098 intermediate symlink containment landed; Tantivy native writer + DuckDB/Parquet runtime executors pending | `bb76006`, `ba87f05`, `ea8c1a8`, `76128fa`, `16985b4`, `cff3670`, `e35f844`, `509e1f1`, `585a456`, `c7e027d`, `9ebbd07`, `734b958`, `3f54ca6`, `8d45fbb`, `2c97eca`, `fa49eb2`, `e1e432d`, `87bacb0`, `d3811b4`, `257a176`, `3b9f79e`, `3be300f`, `0b3dfd0`, `d798b15`, `2d273c2`, `eb88037` | `evidence/lane-03.md` |
