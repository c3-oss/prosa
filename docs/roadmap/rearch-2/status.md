...
Current HEAD: `4169477` (`summariseDerivedLayerFootprint` per-subsystem byte/file rollup + `prosa index-v2 footprint` CLI subcommand).
No-change streak: 0
Ralph active: yes
