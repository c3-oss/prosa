...
Current HEAD: `9033b5b` (`detectCompactionOverlaps` cross-seq correctness audit + `prosa index-v2 compaction-overlaps` CLI subcommand).
No-change streak: 0
Ralph active: yes
...
(none — `CQ-091`..`CQ-113` are all closed.)
