...
Current HEAD: `b07a36c` (`listCompactionHistory` per-manifest timeline + `prosa index-v2 compaction-history` CLI subcommand).
No-change streak: 0
Ralph active: yes
