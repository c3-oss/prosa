...
Current HEAD: pending (`derivedLayerCapabilities` content-free introspection composer + `prosa index-v2 capabilities` CLI subcommand).
No-change streak: 0
Ralph active: yes
