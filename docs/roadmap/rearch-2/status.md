...
Current HEAD: `7a4bcb4` (`derivedLayerCapabilities` content-free introspection composer + `prosa index-v2 capabilities` CLI subcommand).
No-change streak: 0
Ralph active: yes
...
(none — `CQ-091`..`CQ-112` are all closed.)
