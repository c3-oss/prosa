...
Current HEAD: `6b36ff1` (`listCompactedOutputs` + `prosa index-v2 compacted-outputs` manifest-vs-on-disk consistency audit).
No-change streak: 0
Ralph active: yes
