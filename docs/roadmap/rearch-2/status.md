...
| 03 - Derived layer | Ralph | scaffold + SessionBlobPackV2 byte layout + Parquet compaction planner + DuckDB analytics views shape contract landed; Tantivy writer + DuckDB/Parquet runtime executors pending | `bb76006`, `ba87f05`, `ea8c1a8`, `76128fa`, `16985b4` + (this iteration) | `evidence/lane-03.md` |
