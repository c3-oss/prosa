...
Current HEAD: `d471467` (`summariseCompactionEffectiveness` per-seq bytes-in vs bytes-out rollup + `prosa index-v2 compaction-effectiveness` CLI subcommand).
No-change streak: 0
Ralph active: yes
